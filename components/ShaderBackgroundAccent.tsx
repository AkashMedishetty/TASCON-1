...
// Shader with TASCON colors - ACCENT GOLDEN VERSION
const vertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
const fragmentShader = `
  ...
  // TASCON colors: primary #0e192b (14, 25, 43), accent #fdb246 (253, 178, 70)
  vec3 primaryColor = vec3(0.055, 0.098, 0.169); // #0e192b
  vec3 accentColor = vec3(0.992, 0.698, 0.275);  // #fdb246
  vec3 creamColor = vec3(0.961, 0.941, 0.922);   // #f5f0eb
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    * buf[7]
    ...
    // Map to TASCON colors - ACCENT GOLDEN VERSION MAXIMUM IMPACT
